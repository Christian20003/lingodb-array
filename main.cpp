...
int main() {
    ...
    var1 = ArrayRuntime::fromString(var1, 3);
    ...
    var2 = ArrayRuntime::fromString(var2, 11);
    
    std::string string3 = "{2,3}";
    VarLen32 var3 = VarLen32::fromString(string3);
    var3 = ArrayRuntime::fromString(var3, 2);
    ...
    var5 = ArrayRuntime::fromString(var5, 4);

    std::string string6 = "[6:700][4:9]={{2.5,8.2,5.2}}";
    VarLen32 var6 = VarLen32::fromString(string6);
    var6 = ArrayRuntime::fromString(var6, 5);
